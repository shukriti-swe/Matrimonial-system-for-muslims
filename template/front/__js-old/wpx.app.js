...
$('div#msg_body').css('height','500px');
$('#messaging_member_list').css('max-height', '500px');
$('div#msg_body').bind("DOMSubtreeModified",function(){
    $('.z-depth-2-top > .sidebar-object .col-md-5 a').css({"padding":"5px 15px!important","margin":"5px auto","box-shadow":"none!important"});
    var h = $('.z-depth-2-top').height();
    console.log(h);
    var hm = h+50;
    var msg_h = h-97;
    $('div#msg_body').css('height',msg_h);
    $('#messaging_member_list').css('max-height', h);
