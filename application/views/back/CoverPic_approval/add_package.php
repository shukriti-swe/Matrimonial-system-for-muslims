        ...
        <div class="row">
			...
			<form class="form-horizontal" id="package_form" method="POST" action="<?=base_url()?>admin/CoverPic_approval/do_add" enctype="multipart/form-data">
				...
				<div class="panel-footer text-right">
					<a href="<?=base_url()?>admin/CoverPic_approval_reject/<?= $member[$index_no]['cover_pics_id'] ?>" class="btn btn-danger btn-sm btn-labeled fa fa-step-backward" type="submit"><?php echo translate('Reject')?></a>
					<?php if (isset($img)) { ?>
