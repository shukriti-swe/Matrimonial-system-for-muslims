...
<div id="content-container">
	<div id="page-head">
		...
		<ol class="breadcrumb">
			...
			<li class="active"><a href="#"><?php echo translate('cover_pic_packages')?></a></li>
		</ol>
		<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
		<!--End breadcrumb-->
	</div>
	...
	<div id="page-content">
		...
		<div class="panel">
			...
			<div class="text-right" style="margin-right: 30px">
				<a href="<?=base_url()?>admin/coverPic/add_package" id="demo-dt-view-btn" class="btn btn-primary add-tooltip"><i class="fa fa-plus"></i> <?php echo translate('add_new_package')?></a>
			</div>
						...
						<div class="col-sm-4 col-lg-3">
					        ...
					        <div class="panel panel-colorful panel-dark">
					            <div class="panel-body">
									...
									<div class="col-sm-12">
						            	<a href="<?=base_url()?>admin/coverPic/edit_package/<?=$value->plan_id?>" id="demo-dt-view-btn" class="btn btn-mint add-tooltip" style="width: 100%" ><i class="fa fa-edit"></i> <?php echo translate('edit')?></a>
						            </div>
					            </div>
					        </div>
					        <!--===================================================-->
...
<script>
	...
	$("#delete_package").click(function(){
    	$.ajax({
		    ...
		    url: "<?=base_url()?>admin/coverPic/delete/"+$("#delete_package").val(),
		    success: function(response) {
				window.location.href = "<?=base_url()?>admin/coverPic";
		    },
			fail: function (error) {
			    alert(error);
			}
