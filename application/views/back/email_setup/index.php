			...
			<div class="panel-body">
				...
				<div class="tab-base tab-stacked-left">
		            ...
		            <?php
                		...
                		$ads_expired_email = $this->db->get_where('email_template', array('email_template_id' => 28))->result();
                		$ads_url_email = $this->db->get_where('email_template', array('email_template_id' => 24))->result();

                		//cover pic 

                		$cover_pic_payment_complete = $this->db->get_where('email_template', array('email_template_id' => 25))->result();
                		$cover_pic_approve = $this->db->get_where('email_template', array('email_template_id' => 26))->result();
                		$cover_pic_send = $this->db->get_where('email_template', array('email_template_id' => 27))->result();
                		$blank_email_letter = $this->db->get_where('email_template', array('email_template_id' => 29))->result();
                		$paypal_payment_success_mail = $this->db->get_where('email_template', array('email_template_id' => 30))->result();
                		$coverPic_recject_mail = $this->db->get_where('email_template', array('email_template_id' => 31))->result();
                	?>
	           <ul class="nav nav-tabs" style="width: 145px;">
			      ...
			      <li>
				        ...
				        <li>
		                    <a data-toggle="tab" style="color: black; font-weight: bold;" href="#tab-30"><?php echo $paypal_payment_success_mail[0]->subject; ?></a>
		                </li>
		                <li>
		                    <a data-toggle="tab" style="color: black; font-weight: bold;" href="#tab-22"><?php echo $ads_approval_email[0]->subject; ?></a>
		                </li>		     
						   <li>
		                    <a data-toggle="tab" style="color: black; font-weight: bold;" href="#tab-28"><?php echo $ads_expired_email[0]->subject; ?></a>
		                </li>
		                <li>
		                ...
		                <li>
		                    <a data-toggle="tab" style="color: black; font-weight: bold;" href="#tab-25"><?php echo $cover_pic_payment_complete[0]->subject; ?></a>
		                </li>
			      <li>
		                    <a data-toggle="tab" style="color: black; font-weight: bold;" href="#tab-27"><?php echo $cover_pic_send[0]->subject; ?></a>
		                </li>
		                <li>
		                    <a data-toggle="tab" style="color: black; font-weight: bold;" href="#tab-26"><?php echo $cover_pic_approve[0]->subject; ?></a>
		                </li>
			      <li>
		                    <a data-toggle="tab" style="color: black; font-weight: bold;" href="#tab-31"><?php echo $coverPic_recject_mail[0]->subject; ?></a>
		                </li>
		                <li>
		                    <a data-toggle="tab" style="color: black; font-weight: bold;" href="#tab-29"><?php echo $blank_email_letter[0]->subject; ?></a>
		                </li>
		            ...
		            <div class="tab-content">
		                ...
		                <div id="tab-28" class="tab-pane fade">
		                	<?php
		                	foreach ($ads_expired_email as $value28) {
		                	?>
		                	<form class="form-horizontal" id="email_setup_form" method="POST" action="<?=base_url()?>admin/update_email_setup/ads_expired_email">
			                	<div class="form-group btm_border">
	                                <label class="col-sm-2 control-label"><b><?=translate('subject')?></b>
	                                </label>
	                                <div class="col-sm-8 col-sm-offse">
	                                	<input type="text" name="ads_expired_email_sub" value="<?=$value28->subject?>" placeholder="" class="form-control" >
	                                </div>
	                            </div>
	                            <div class="form-group btm_border">
	                                <label class="col-sm-2 control-label"><b><?=translate('email_body')?></b>
	                                ...
	                                <div class="col-sm-8">
	                                    <textarea rows="15" class="form-control textarea" data-height="100" name="ads_expired_email_body" style="height: 380px;"><?=$value28->body?></textarea>
	                                    <br>
	                                    <span class="text-danger">**N.B : <?=translate('Do Not Change The Variables Like')?> [[ ____ ]].**</span>
	                                </div>
	                            </div>
		                ...
		                <div id="tab-25" class="tab-pane fade">
		                	<?php
		                	foreach ($cover_pic_payment_complete as $value1) {
		                	?>
		                	<form class="form-horizontal" id="email_setup_form" method="POST" action="<?=base_url()?>admin/update_email_setup/cover_pic_payment_complete">
			                	<div class="form-group btm_border">
	                                <label class="col-sm-2 control-label" for="email_setup"><b><?=translate('subject')?></b>
	                                </label>
	                                <div class="col-sm-8 col-sm-offse">
	                                	<input type="text" name="cover_pic_payment_complete_sub" value="<?=$value1->subject?>" placeholder="" class="form-control" >
	                                </div>
	                            </div>
	                            <div class="form-group btm_border">
	                                <label class="col-sm-2 control-label" for="email_setup"><b><?=translate('email_body')?></b>
	                                ...
	                                <div class="col-sm-8">
	                                    <textarea rows="15" class="form-control textarea" data-height="100" name="cover_pic_payment_complete_body" style="height: 380px;"><?=$value1->body?></textarea>
	                                    <br>
	                                    <span class="text-danger">**N.B : <?=translate('Do Not Change The Variables Like')?> [[ ____ ]].**</span>
	                                </div>
	                            </div>
		                ...
		                <div id="tab-26" class="tab-pane fade">
		                	<?php
		                	foreach ($cover_pic_approve as $value1) {
		                	?>
		                	<form class="form-horizontal" id="email_setup_form" method="POST" action="<?=base_url()?>admin/update_email_setup/cover_pic_approve">
			                	<div class="form-group btm_border">
	                                <label class="col-sm-2 control-label" for="email_setup"><b><?=translate('subject')?></b>
	                                </label>
	                                <div class="col-sm-8 col-sm-offse">
	                                	<input type="text" name="cover_pic_approve_sub" value="<?=$value1->subject?>" placeholder="" class="form-control" >
	                                </div>
	                            </div>
	                            <div class="form-group btm_border">
	                                <label class="col-sm-2 control-label" for="email_setup"><b><?=translate('email_body')?></b>
	                                ...
	                                <div class="col-sm-8">
	                                    <textarea rows="15" class="form-control textarea" data-height="100" name="cover_pic_approve_body" style="height: 380px;"><?=$value1->body?></textarea>
	                                    <br>
	                                    <span class="text-danger">**N.B : <?=translate('Do Not Change The Variables Like')?> [[ ____ ]].**</span>
	                                </div>
	                            </div>
		                ...
		                <div id="tab-27" class="tab-pane fade">
		                	<?php
		                	foreach ($cover_pic_send as $value1) {
		                	?>
		                	<form class="form-horizontal" id="email_setup_form" method="POST" action="<?=base_url()?>admin/update_email_setup/cover_pic_send">
			                	<div class="form-group btm_border">
	                                <label class="col-sm-2 control-label" for="email_setup"><b><?=translate('subject')?></b>
	                                </label>
	                                <div class="col-sm-8 col-sm-offse">
	                                	<input type="text" name="cover_pic_send_sub" value="<?=$value1->subject?>" placeholder="" class="form-control" >
	                                </div>
	                            </div>
	                            <div class="form-group btm_border">
	                                <label class="col-sm-2 control-label" for="email_setup"><b><?=translate('email_body')?></b>
	                                ...
	                                <div class="col-sm-8">
	                                    <textarea rows="15" class="form-control textarea" data-height="100" name="cover_pic_send_body" style="height: 380px;"><?=$value1->body?></textarea>
	                                    <br>
	                                    <span class="text-danger">**N.B : <?=translate('Do Not Change The Variables Like')?> [[ ____ ]].**</span>
	                                </div>
	                            </div>
		                ...
		                <div id="tab-29" class="tab-pane fade">
		                	<?php
		                	foreach ($blank_email_letter as $value29) {
		                	?>
		                	<form class="form-horizontal" id="email_setup_form" method="POST" action="<?=base_url()?>admin/update_email_setup/blank_email_letter">
			                	<div class="form-group btm_border">
	                                <label class="col-sm-2 control-label" for="email_setup"><b><?=translate('subject')?></b>
	                                </label>
	                                <div class="col-sm-8 col-sm-offse">
	                                	<input type="text" name="blank_email_letter_sub" value="<?=$value29->subject?>" placeholder="" class="form-control" >
	                                </div>
	                            </div>
	                            <div class="form-group btm_border">
	                                <label class="col-sm-2 control-label" for="email_setup"><b><?=translate('email_body')?></b>
	                                ...
	                                <div class="col-sm-8">
	                                    <textarea rows="15" class="form-control textarea" data-height="100" name="blank_email_letter_body" style="height: 380px;"><?=$value29->body?></textarea>
	                                    <br>
	                                    <span class="text-danger">**N.B : <?=translate('Do Not Change The Variables Like')?> [[ ____ ]].**</span>
	                                </div>
	                            </div>
		                ...
		                <div id="tab-30" class="tab-pane fade">
		                	<?php
		                	foreach ($paypal_payment_success_mail as $value30) {
		                	?>
		                	<form class="form-horizontal" id="email_setup_form" method="POST" action="<?=base_url()?>admin/update_email_setup/paypal_payment_success_mail">
			                	<div class="form-group btm_border">
	                                <label class="col-sm-2 control-label" for="email_setup"><b><?=translate('subject')?></b>
	                                </label>
	                                <div class="col-sm-8 col-sm-offse">
	                                	<input type="text" name="paypal_payment_success_mail_sub" value="<?=$value30->subject?>" placeholder="" class="form-control" >
	                                </div>
	                            </div>
	                            <div class="form-group btm_border">
	                                <label class="col-sm-2 control-label" for="email_setup"><b><?=translate('email_body')?></b>
	                                ...
	                                <div class="col-sm-8">
	                                    <textarea rows="15" class="form-control textarea" data-height="100" name="paypal_payment_success_mail_body" style="height: 380px;"><?=$value30->body?></textarea>
	                                    <br>
	                                    <span class="text-danger">**N.B : <?=translate('Do Not Change The Variables Like')?> [[ ____ ]].**</span>
	                                </div>
	                            </div>
		                ...
		                <div id="tab-31" class="tab-pane fade">
		                	<?php
		                	foreach ($coverPic_recject_mail as $value31) {
		                	?>
		                	<form class="form-horizontal" id="email_setup_form" method="POST" action="<?=base_url()?>admin/update_email_setup/coverPic_recject_mail">
			                	<div class="form-group btm_border">
	                                <label class="col-sm-2 control-label" for="email_setup"><b><?=translate('subject')?></b>
	                                </label>
	                                <div class="col-sm-8 col-sm-offse">
	                                	<input type="text" name="coverPic_recject_mail_sub" value="<?=$value31->subject?>" placeholder="" class="form-control" >
	                                </div>
	                            </div>
	                            <div class="form-group btm_border">
	                                <label class="col-sm-2 control-label" for="email_setup"><b><?=translate('email_body')?></b>
	                                ...
	                                <div class="col-sm-8">
	                                    <textarea rows="15" class="form-control textarea" data-height="100" name="coverPic_recject_mail_body" style="height: 380px;"><?=$value31->body?></textarea>
	                                    <br>
	                                    <span class="text-danger">**N.B : <?=translate('Do Not Change The Variables Like')?> [[ ____ ]].**</span>
	                                </div>
	                            </div>
