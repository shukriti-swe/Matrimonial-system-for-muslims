...
<div id="content-container">
	<div id="page-head">
		...
		<ol class="breadcrumb">
			...
			<li class="active"><a href="#"><?php echo translate('advertisement_packages')?></a></li>
		</ol>
		<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
		<!--End breadcrumb-->
	</div>
	...
	<div id="page-content">
		...
		<div class="panel">
			...
			<div class="text-right" style="margin-right: 30px">
				<a href="<?=base_url()?>admin/ads_plan/add_package" id="demo-dt-view-btn" class="btn btn-primary add-tooltip"><i class="fa fa-plus"></i> <?php echo translate('add_new_package')?></a>
			</div>
					        ...
					        <div class="panel panel-colorful panel-dark">
					            <div class="panel-body">
					            	<div class="text-right">
					            		<button data-target='#delete_modal' data-toggle='modal' class="btn btn-danger btn-xs add-tooltip" style="border-radius: 50%;" onclick="delete_package(<?=$value->id?>)"><i class="fa fa-close"></i></button>
					            	</div>
									...
									<div class="text-center" style="margin-top: 22px;">
										...
										?> -->
										<h3 class="panel-title">Duration: <?=$value->duration?> Month</h3>
										<h3 class="panel-title">Amount: <?=$value->amount?></h3>
										
									</div>
									<div class="col-sm-12">
						            	<a href="<?=base_url()?>admin/ads_plan/edit_package/<?=$value->id?>" id="demo-dt-view-btn" class="btn btn-mint add-tooltip" style="width: 100%" ><i class="fa fa-edit"></i> <?php echo translate('edit')?></a>
						            </div>
					            </div>
					        </div>
					        <!--===================================================-->
...
<script>
	...
	$("#delete_package").click(function(){
    	$.ajax({
		    ...
		    url: "<?=base_url()?>admin/ads_plan/delete/"+$("#delete_package").val(),
		    success: function(response) {
				window.location.href = "<?=base_url()?>admin/ads_plan";
		    },
			fail: function (error) {
			    alert(error);
			}
