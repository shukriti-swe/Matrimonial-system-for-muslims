...
<div id="content-container">
	<div id="page-head">
		...
		<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
		<div id="page-title">
			<h1 class="page-header text-overflow"><?php echo translate('ads_earnings')?></h1>
		...
		<ol class="breadcrumb">
			...
			<li class="active"><a href="#"><?php echo translate('ads_earnings')?></a></li>
		</ol>
		<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
		<!--End breadcrumb-->
	</div>
	...
	<div id="page-content">
		...
		<div class="panel">
			...
			<div class="panel-heading">
				<h3 class="panel-title"><?php echo translate('ads_earnings_list')?></h3>
			</div>
			<div class="panel-body">
				<div class="row">
					<table id="ads_earnings_table" class="table table-striped table-bordered" cellspacing="0" width="100%">
						<thead>
						<tr>
							<th>
								<?php echo translate('Ads_id')?>
							</th>
							<!-- <th>
								<?php echo translate('ads_unique_id')?>
							</th> -->
							<th>
								<?php echo translate('name_of_business')?>
							</th>
							<th>
...
<script>
    $(document).ready(function () {
        $('#ads_earnings_table').DataTable({
            "processing": true,
            "serverSide": true,
            "ajax":{
				"url": "<?php echo base_url('admin/ads_earnings/list_data') ?>",
				"dataType": "json",
				"type": "POST",
...
<script>
	function get_detail(id) {
	    ...
	    $.ajax({
		    url: "<?=base_url()?>admin/ads_earnings/view_detail/"+id,
	...
	$("#delete_earning").click(function(){
    	$.ajax({
		    url: "<?=base_url()?>admin/ads_earnings/delete/"+$("#delete_earning").val(),
		    success: function(response) {
				window.location.href = "<?=base_url()?>admin/ads_earnings";
		    },
			fail: function (error) {
                                debugger
			    alert(error);
