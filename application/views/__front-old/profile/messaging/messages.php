        ...
        ?>
            ...
            <div class="direct-chat-msg right">
                <div class="direct-chat-info clearfix">
                    ...
                    <span class="direct-chat-timestamp text-right pull-right"><?=date('F d ,yy - h:i A', $message->message_time)?></span>
                </div>
                <!-- /.direct-chat-info -->
                <?php 
        ...
        ?>
            ...
            <div class="direct-chat-msg ">
                <div class="direct-chat-info clearfix">
                    ...
                    <span class="direct-chat-timestamp "><?=date('F d ,yy - h:i A', $message->message_time)?></span>
                </div>
                <!-- /.direct-chat-info -->
