...
?>
<div class="col-lg-2" id="div_properties_search">
    <div class="card card-inverse no-border no-radius" style="min-height: 400px" style="min-width: 150px">
        <div class="card-body py-4 px-4">
            <form class="form-inverse mt-4" data-toggle="validator" role="form" action="<?=base_url()?>home/listing/home_search" method="POST" style="margin-top: 0px !important;">
                <h3 class="heading heading-5 strong-500 text-capitalize" align="center">Search</h3>
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group has-feedback">
                            <label class="text-uppercase"><?php echo translate("")?></label>
                            <?= $this->Crud_model->select_html('gender', 'gender', 'name', 'edit', 'form-control form-control-sm selectpicker', '', '', '', ''); ?>
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
                </div>
				                          <label for="" class="text-uppercase">Age</label>
                <div class="row">
                    <div class="col-sm-5">
                        <div class="form-group has-feedback">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group has-feedback">
                            ...
                            <?= $this->Crud_model->select_html('state', 'state', 'name', 'edit', 'form-control form-control-sm selectpicker', '', 'country_id', '231', ''); ?>
                            <div class="help-block with-errors">
                            </div>
                        </div>
                    </div>
