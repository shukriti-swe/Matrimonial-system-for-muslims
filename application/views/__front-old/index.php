...
<?php if (!empty($this->session->userdata['member_id'])) { ?>
        ...
        <script>
                ...
                function open_message_box(thread_id, now, displaynumber) {
                   ...
                   //       $("#msg_box_header").html("<a class='c-base-1' target='_blank' ></a>  \xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0  MESSAGES  ");
                                        ...
                                        success: function(response) {
                                                ...
                                                $.ajax({
                                                        ...
                                                        success: function(response) {
                                                                $("#msg_body").html(response);
                                                             //$.ajax({
                                                            //    url: "<?//=base_url()?>//admin/send_message_email/"+to,
                                                            //});
                                                        }
                                                });
                                        }
