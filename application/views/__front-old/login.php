...
<html>
    ...
    <body>
        ...
        <section class="has-bg-cover bg-size-cover" style="background-image: url(<?=base_url()?>uploads/login_image/<?=$login_image_data[0]['image']?>); background-position: bottom bottom; padding-top: 15rem; padding-bottom: 15rem;"">
