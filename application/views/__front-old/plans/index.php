<section class="page-title page-title--style-1" style="border-top: 2px solid black; border-bottom: 2px solid black;">
    <div class="container">
        ...
        <div class="row">
            ...
            <?php foreach ($all_plans as $value): ?>
                ...
                <div class="col-lg-2 col-md-6 col-sm-6 col-xs-12">
                    ...
                    <div class="feature feature--boxed-border feature--bg-2 active package_bg mt-4" style="background: black !important;">
                        <div class="icon-block--style-1-v5 text-center">
                            ...
                            <div class="block-content">
                                ...
                                <h3 class="price-tag" style="font-size: 26px; color: white;"><?=currency($value->amount)?></h3>
                                <ul class="pl-0 pr-0 mt-0">
                                    ...
                                    <li style="color: white;" class="<?=$package_class?> package_items"><?=translate('express_interests:')?> <?=$value->express_interest?> <?=translate('times')?></li>
                                    <li style="color: white;" class="<?=$package_class?> package_items"><?=translate('direct_messages:')?> <?=$value->direct_messages?> <?=translate('times')?></li>
                                    <li style="color: white;" class="<?=$package_class?> package_items"><?=translate('photo_gallery:')?> <?=$value->photo_gallery?> <?=translate('images')?></li>
                                </ul>
                                <div class="py-2 text-center mb-2">
                                    ...
                                    ?>
                                    <a href="<?=$purchase_link?>" class="btn btn-styled btn-sm btn-base-1 btn-outline btn-circle" style="background-color: #E91E63 !important;">
                                        <span  style="color: white;" class="<?=$package_class?>"><?php echo translate('get_this_package')?></span>
                                    </a>
                                </div>
                            </div>
                        </div>
