			...
			<div class="nano-content">
				<ul id="mainnav-menu" class="list-group">
                            ...
                            ?>
								<li <?php if($page_name=="picture_video_approval"){ ?> class="active-link" <?php } ?>>
									<a href="<?=base_url()?>admin/picture_video_approval">
										...
										<span class="menu-title notification"><?php echo translate('picture_/_video_approvals') ?>
							...
							<?php } if ( $this->Crud_model->admin_permission('CoverPic_approval') ){
								...
								<li <?php if($page_name=="CoverPic_approval"){ ?> class="active-link" <?php } ?>>
									<a href="<?=base_url()?>admin/CoverPic_approval">
										...
										<span class="badge badge-light"> <?= $notification; ?> </span>
									</a>
								</li>
    						<?php } ?>
						</ul>
					...
					<?php 
                            ...
                            ?>
					<li <?php if($page_name=="advertisements"||$page_name=="packages"||$page_name=="coverPic"){ ?> class="active-sub active" <?php } ?>>
						<a href="#">
							<i class="fa fa-users"></i>
							<span class="menu-title"><?php echo translate('Payments')?></span>
							<i class="arrow"></i>
						</a>
						<!--Submenu-->
						<ul class="collapse">
							...
							<li <?php if($page_name=="advertisements"){ ?> class="active-link" <?php } ?>>
								...
								<a href="<?=base_url()?>admin/advertisements"><i class="fa fa-circle-o"></i> <?php echo translate('advertisements')?>  </a>
						...
						<?php }if ($this->Crud_model->admin_permission('platinum_plans')){
							...
							<li <?php if($page_name=="coverPic"){ ?> class="active-link" <?php } ?>>
								<a href="<?=base_url()?>admin/coverPic">
									...
									<span class="menu-title"><?php echo translate('cover_pic_plans')?></span>
								</a>
							</li>
    						<?php } ?>
						</ul>
