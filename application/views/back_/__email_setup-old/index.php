			...
			<div class="panel-body">
				...
				<div class="tab-base tab-stacked-left">
		            ...
		            <ul class="nav nav-tabs" style="width: 145px;">
		                <li class="active">
		                    <a data-toggle="tab" style="color: black;    font-weight: bold;" href="#tab-1"><?php echo translate('password_reset_email')?></a>
		                </li>
		                <li>
		                    <a data-toggle="tab" style="color: black;    font-weight: bold;" href="#tab-2"><?php echo translate('package_purchase_email')?></a>
		                </li>
		                <li>
		                    <a data-toggle="tab" style="color: black;    font-weight: bold;" href="#tab-3"><?php echo translate('account_opening_email')?></a>
		                </li>
		                <li>
		                    <a data-toggle="tab" style="color: black;    font-weight: bold;" href="#tab-4"><?php echo translate('staff_account_add_email')?></a>
		                </li>
		                <li>
		                    <a data-toggle="tab" style="color: black;    font-weight: bold;" href="#tab-5">Deleted Members Email</a>
		                </li>
		                <li>
		                    <a data-toggle="tab" style="color: black;    font-weight: bold;" href="#tab-6">No Picture Email</a>
		                </li>
		                <li>
		                    <a data-toggle="tab" style="color: black;    font-weight: bold;" href="#tab-7">Incomplete Profile Email</a>
		                </li>
		                <li>
		                    <a data-toggle="tab" style="color: black;    font-weight: bold;" href="#tab-8">No Picture and Incomplete Profile Email</a>
		                </li>
		            </ul>
		            ...
		            <div class="tab-content">
		                ...
		                <div id="tab-6" class="tab-pane fade">
							<?php
		                	$no_picture_email = $this->db->get_where('email_template', array('email_template_id' => 7))->result();
		                	?>
		                	<?php
		                	foreach ($no_picture_email as $value6) {
		                	?>
		                	<form class="form-horizontal" id="email_setup_form" method="POST" action="<?=base_url()?>admin/update_email_setup/no_pic_email">
			                	<div class="form-group btm_border">
	                                <label class="col-sm-2 control-label" for="email_setup"><b><?=translate('subject')?></b>
	                                </label>
	                                <div class="col-sm-8 col-sm-offse">
	                                	<input type="text" name="no_pic_email_sub" value="<?=$value6->subject?>" placeholder="" class="form-control" >
	                                </div>
	                            </div>
	                            <div class="form-group btm_border">
	                                <label class="col-sm-2 control-label" for="email_setup"><b><?=translate('email_body')?></b>
	                                ...
	                                <div class="col-sm-8">
	                                    <textarea rows="15" class="form-control textarea" data-height="100" name="no_pic_email_body" style="height: 380px;"><?=$value6->body?></textarea>
	                                    <br>
	                                    <span class="text-danger">**N.B : <?=translate('Do Not Change The Variables Like')?> [[ ____ ]].**</span>
	                                </div>
	                            </div>
		                ...
		                <div id="tab-8" class="tab-pane fade">
							<?php
		                	$no_pic_profile_email = $this->db->get_where('email_template', array('email_template_id' => 9))->result();
		                	?>
		                	<?php
		                	foreach ($no_pic_profile_email as $value8) {
		                	?>
		                	<form class="form-horizontal" id="email_setup_form" method="POST" action="<?=base_url()?>admin/update_email_setup/no_pic_profile_email">
			                	<div class="form-group btm_border">
	                                ...
	                                <div class="col-sm-8 col-sm-offse">
	                                	<input type="text" name="no_pic_profile_email_sub" value="<?=$value8->subject?>" placeholder="" class="form-control" >
	                                </div>
	                            </div>
	                            <div class="form-group btm_border">
	                                <label class="col-sm-2 control-label" for="email_setup"><b><?=translate('email_body')?></b>
	                                ...
	                                <div class="col-sm-8">
	                                    <textarea rows="15" class="form-control textarea" data-height="100" name="no_pic_profile_email_body" style="height: 380px;"><?=$value8->body?></textarea>
	                                    <br>
	                                    <span class="text-danger">**N.B : <?=translate('Do Not Change The Variables Like')?> [[ ____ ]].**</span>
	                                </div>
	                            </div>
