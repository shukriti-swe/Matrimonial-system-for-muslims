				...
				<div class="row">
					<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
						...
						<tr>
							...
							<th>
								<?php echo translate('display_date')?>
							</th>
							<th>
							...
							<?php
								...
								?>
									<tr>
										...
										<td>
											<?= date("F d" , strtotime($value->start_date) )." - ".date("F d , Y" , strtotime($value->end_date) ); ?>
    ...
    <div class="modal-dialog" style="width: 400px;">
        <div class="modal-content">
            ...
            <div class="modal-body">
            	...
            	<div class="text-right">
            		<button data-dismiss="modal" class="btn btn-default btn-sm" type="button" id="modal_close"><?php echo translate('close')?></button>
                	<button class="btn btn-success btn-sm" id="reject_ads" value=""><?php echo translate('Recject')?></button>
            	</div>
            </div>
    ...
    <div class="modal-dialog" style="width: 400px;">
        <div class="modal-content">
            ...
            <div class="modal-header">
           	...
           	<!--Modal body-->
            <div class="modal-body">
            	<p><?php echo translate('are_you_sure_you_want_to_send_mail_notification_this?')?></p>
            	<div class="text-right">
            		<button data-dismiss="modal" class="btn btn-default btn-sm" type="button" id="modal_close"><?php echo translate('close')?></button>
...
<script>
	...
	$("#save_advertisements").click(function(){
