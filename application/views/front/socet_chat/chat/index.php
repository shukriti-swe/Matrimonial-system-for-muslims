...
<div class="sidebar sidebar-inverse rs_border sidebar--style-1 bg-base-1 z-depth-2-top">
        ...
        <div class="row">
            ...
            <div class="profile-picture profile-picture--style-2" id="dp">
                    <div style="border: 10px solid rgba(255, 255, 255, 0.1);width:90px;border-radius: 50%;margin:auto;">
                        <div  class='profile_img new_pic_profile' id="groupMembers_" style="background-image: url(<?= base_url() ?>uploads/profile_image/<?= $member_id . "/" .$image.'?'.rand(999,99999999) ?>)"></div>
                    </div>
            </div>
        </div>
        <div class="profile-stats clearfix mt-2">
            ...
            <div class="middleSection col-md-6" style="border:none">
				...
				<div class="chat_box_m"> 
                    <div class="chat" style="overflow: scroll;overflow-x: hidden;" id="chatBox" ></div>
				...
				<?php  $view_profiler_id=$get_member->member_id; ?>
				<input type="hidden" id="select_profiler_id" name="profiler_id" value="<?php echo $view_profiler_id ?>">
				
				
            <div class="rightSection  col-md-3 " style="text-overflow: ellipsis;overflow-x: hidden;overflow-y: hidden;padding: 0;"> 
                <div class="rs_right_h">
					 <span class="" style="padding: 0;"><i class="fa fa-users" style="color: #fff;margin-right: 5px" ></i></span>CHAT LIST 
				</div>     
    ...
    $(document).ready(function(){
        ...
        function printGroupList(groups){
            ...
            for(let i=0;i<groups.length;i++){
                ...
                html += " <li class=\"person\" data-chat=\"person1\" id='sssssssss' data-mecreator="+groups[i].meCreator+" data-group=\""+groups[i].groupId+"\">";
