...
?>
<section class="slice--offset" style="position: relative;overflow-x: hidden;background-position: center top;background-repeat: no-repeat;background-size: cover;padding-top: 4rem;padding-bottom: 4rem;background-image: url(<?=base_url()?>uploads/home_page/parallax_image/<?=$parallax_image[0]['image']?>);">
    ...
    <div class="container">
        <div class="row py-3 justify-content-center">
            <div class="col-lg-8 col-md-8 text-center">
                ...
                <div class="fluid-paragraph fluid-paragraph-sm mb-3 c-white">
                    <?=$home_parallax_text?>
                </div>
