                            ...
                            <div class="icon-block--style-1-v5 text-center">
                                <div class="block-icon c-gray-dark">
                                    ...
                                    <?php
                                        ...
                                        ?>
                                            <img src="<?=base_url()?>uploads/plan_image/<?=$images[0]['thumb']?>" class="img-sm" height="200">
                                        <?php
                                        }
                                        else {
                                        ?>
                                            <img src="<?=base_url()?>uploads/plan_image/default_image.png" class="img-sm" height="200">
                                        <?php
                                        }
                                    ?>
                                    </li>
                                ...
                                <!--<div class="block-content">
                                    ...
                                    <ul class="pl-0 pr-0">
                                        <li class="package_items"><?=translate('Zayeqa Restaurant')?> <?=$value->express_interest?> <?=translate('times')?></li>
                                        <li class="package_items"><?=translate('29208 Orchard Lake RD.')?> <?=$value->direct_messages?> <?=translate('times')?></li>
                                        <li class="package_items"><?=translate('')?> <?=$value->photo_gallery?> <?=translate('images')?></li>
                                    </ul>
