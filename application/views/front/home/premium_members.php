    ...
    <div class="container">
        ...
        <div class="swiper-js-container">
            <div class="swiper-container" data-swiper-autoplay="true" data-swiper-items="4" data-swiper-space-between="20" data-swiper-md-items="3" data-swiper-md-space-between="20" data-swiper-sm-items="2" data-swiper-sm-space-between="20" data-swiper-xs-items="1" data-swiper-xs-space-between="0">
                <div class="swiper-wrapper pb-5" style="padding-bottom: 0px !important;" id="premium_all_members">
                                    ...
                                    <div class="profile-picture profile-picture--style-2">
                                        <center>
                                            <?php
                                                ...
                                                <?php }else{ ?>
                                                    <!-- <div class="home_pm" style="background-image: url(<?=base_url()?>uploads/profile_image/<?=$premium_member->member_id.'/'.$premium_member->profile_image?>)">
                                                    </div> -->
                                                    ...
                                                    ?>
                                                        <!-- <div class="home_pm" style="background-image: url(<?=base_url()?>uploads/profile_image/<?=$premium_member->member_id.'/'.$premium_member->profile_image?>)"></div> -->
                                            ...
                                            ?>
                                            <!-- <img loading="lazy" src="<?=base_url()?>template/front/uploads/profile_image/"> -->
                                        </center>
                                    </div>
...
<script>
    ...
    $(document).ready(function() {
        $.ajax({
            type: "POST",
            url: "<?= base_url() ?>home/get_all_premium_member/",
            cache: false,
            success: function(response) {
               $('#premium_all_members').html(response);
            }
        });
    });
