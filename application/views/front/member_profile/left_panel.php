...
<?php $has_video = 0; ?>
<div class="sidebar sidebar-inverse sidebar--style-1 bg-base-1 z-depth-2-top" style="min-height: 564px">
    <div class="sidebar-object mb-0">
        ...
        <div id="container">
            <div class="row">
                ...
                <div class="col-md-4">
                    <?php if($get_member[0]->isOnline != 0){ ?>
                        <span style="float:left" class="online"> Online </span>
                    <?php }else{ ?>
                        <span style="float:left;color:#e91e63" class="offline">Offline</span>
                    <?php } ?>
                ...
                <div class="row" style="margin-top: 4px;">
                    <div class="col-sm-12 size-sm">
                        ...
                        <?php 
							 // added AS 
                            // check gender
                            $logInMemberGender = $this->Crud_model->get_type_name_by_id('member', $this->session->userdata('member_id'), 'gender');

                            $otherMemberGender = $this->Crud_model->get_type_name_by_id('member', $get_member[0]->member_id, 'gender');
                    	...
                    	if ($logInMemberGender != $otherMemberGender) { ?>
                           <?php if ( $logInMemberMembership != 4 || $otherMemberMembership != 4) { ?>
                        <a style="color:#000;box-shadow:none;" class="<?=$message_class?>" id="message_a_<?=$get_member[0]->member_id?>" <?php if ($message_onclick == 1){	?>onclick="return profile_load('a',	<?=$get_member[0]->member_id?>)"<?php 	} elseif ($message_onclick == 0){ ?>onclick="profile_load('a',<?=$get_member[0]->member_id?>);"<?php	}	?>>
