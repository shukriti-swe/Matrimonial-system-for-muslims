...
<div class="feature feature--boxed-border feature--bg-1 pt-3 pb-0 pl-3 pr-3 mb-3 border_top2x">
    <div id="info_basic_info">
        <div class="card-inner-title-wrapper pt-0">
            <h3 class="card-inner-title pull-left" style="top:3px">
                <!--<?php echo translate('basic_information')?>-->
				PROFILE
            </h3>
				<small style="position: absolute;top: 18px;left: 0px; width:100%; text-align-center">Your name, telephone, or email will NOT be displayed to other members</small>
			...
			<div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group has-feedback">
                        ...
                        <?php
                            echo $this->Crud_model->select_html('disabilities', 'Disabilities', 'name', 'edit', 'form-control form-control-sm selectpicker', $basic_info_data[0]['Disabilities'], '', '', '');
                        ?>
                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                        <div class="help-block with-errors"></div>
                    </div>
