                ...
                <table class="table table-xs table-profile table-striped table-bordered table-responsive-sm">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
							<?=$this->Crud_model->get_type_name_by_id('yes_no_sometime', $astronomic_information_data[0]['do_i_fast'])?>
                            ...
                            <td>
							<?=$this->Crud_model->get_type_name_by_id('yes_no_sometime', $astronomic_information_data[0]['do_i_pray'])?>
                            ...
                            <td>
							<?=$this->Crud_model->get_type_name_by_id('yes_no_sometime', $astronomic_information_data[0]['do_i_eat_halal'])?>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group has-feedback">
                        ...
                        <?php
                            echo $this->Crud_model->select_html('yes_no_sometime', 'do_i_fast', 'name', 'edit', 'form-control form-control-sm selectpicker', $astronomic_information_data[0]['do_i_fast'], '', '', '');
                        ?>
                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                        <div class="help-block with-errors"></div>
                    </div>
				...
				<div class="col-md-4">
                    <div class="form-group has-feedback">
                        ...
                        <?php
                            echo $this->Crud_model->select_html('yes_no_sometime', 'do_i_pray', 'name', 'edit', 'form-control form-control-sm selectpicker', $astronomic_information_data[0]['do_i_pray'], '', '', '');
                        ?>
                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                        <div class="help-block with-errors"></div>
                    </div>
				...
				<div class="col-md-4">
                    <div class="form-group has-feedback">
                        ...
                        <?php
                            echo $this->Crud_model->select_html('yes_no_sometime', 'do_i_eat_halal', 'name', 'edit', 'form-control form-control-sm selectpicker', $astronomic_information_data[0]['do_i_eat_halal'], '', '', '');
                        ?>
                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                        <div class="help-block with-errors"></div>
                    </div>
