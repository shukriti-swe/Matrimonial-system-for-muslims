				...
				if ($footer_logo_position == 'left') {                                            ?>
					<div class="col-md-3 col-lg-3" style="text-align: left;line-height: 1;padding-left: 5px !important;padding-right: 5px !important;">
						<div class="col" style="padding-left: 2px !important;padding-right: 2px !important;">
							...
							<small style="line-height: 0.5rem;padding: 0.25rem 0;font-size: 0.8rem;font-weight: 400;">Match Made In Jannah<br />1950 S. Rochester Rd. #1102</br>
Rochester Hills, MI 48037<br />(248) 934-0075
								<!--<br />customers@matchmadeinjannah.com<br />techelp@matchmadeinjannah.com<br />success@matchmadeinjannah.com-->
								</small>
						</div>
					</div>
				<?php                                            }                                        ?>
