   ...
   function account_activation($email = '') {
            ...
            if ($protocol == 'smtp') {
                ...
                $from = $this->db->get_where('general_settings', array('type' => 'system_email'))->row()->value;
                    ...
                    $email_body = "Your account is activated please login and complete your profile to continue using Match Made In Jannah";
    ...
    function new_account_notification($email = '', $name = '') {
    			...
    			$email_body = "A new user has been registered with name ".$name ." and email ".$email." please unblock the account from admin panel to allow the user to use his account.";
            ...
            function send_contact_us($email = '', $message = '') {
    			...
    			$email_body = "There is a new message from: ".$email."  \nMessage: ".$message;
