...
class Crud_model extends CI_Model
{
    ...
    {
        if ($multi == '') {
            $destFile = 'uploads/' . $type . '_image/' . $type . '_' . $id . $ext;
  ...
  function get_listed_messaging_members($member_id)
    ...
    {
        $counter = $this->db->query("SELECT COUNT(message_thread_id) AS messageCount FROM message_thread WHERE (message_to_seen = '' AND message_thread_to = $member_id) OR (message_from_seen = '' AND message_thread_from = $member_id)")->result_array();
