...
function print_graph($g,$pgwidth) {
	...
	if (isset($g['attr']['DATA-uik-BEGIN']) && ($g['attr']['DATA-uik-BEGIN'] === '0' || $g['attr']['DATA-uik-BEGIN'] > 0)) { $colbegin = $g['attr']['DATA-uik-BEGIN']; }

	if (isset($g['attr']['DATA-ROW-END']) && ($g['attr']['DATA-ROW-END'] === '0' || $g['attr']['DATA-ROW-END'] <> 0)) { $rowend = $g['attr']['DATA-ROW-END']; }
	if (isset($g['attr']['DATA-uik-END']) && ($g['attr']['DATA-uik-END'] === '0' || $g['attr']['DATA-uik-END'] <> 0)) { $colend = $g['attr']['DATA-uik-END']; }
